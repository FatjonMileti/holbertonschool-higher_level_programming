...
* Class `Base`:
    * private class attribute `__nb_objects = 0`# Almost a Circle
...
**Solution:** [models/base.py](https://github.com/FatjonMileti/holbertonschool-higher_level_programming/blob/master/0x0C-python-almost_a_circle/models/base.py), [models/__init__.py](https://github.com/FatjonMileti/holbertonschool-higher_level_programming/blob/master/0x0C-python-almost_a_circle/models/__init__.py)
...
**Solution:** [models/rectangle.py](https://github.com/FatjonMileti/holbertonschool-higher_level_programming/blob/master/0x0C-python-almost_a_circle/models/rectangle.py)
...
**Solution:** [models/square.py](https://github.com/FatjonMileti/holbertonschool-higher_level_programming/blob/master/0x0C-python-almost_a_circle/models/square.py)
...
**Solution:** [models/base.py](https://github.com/FatjonMileti/holbertonschool-higher_level_programming/blob/master/0x0C-python-almost_a_circle/models/base.py)
